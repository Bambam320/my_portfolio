...
function Experience() {
  ...
  return (
    ...
    //             <img className='port-gif' src={gif} alt="Fakeify Gif" style={port1 ? {opacity: "1"} : {opacity: "0"}}/>
    //             <img className='port-gif port-gif-logo' src={gif} alt="Fakeify Logo" style={port1 ? {opacity: "0"} : {opacity: "1"}}/>
    //           </div>
